      ...
      >
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-200 dark:bg-gray-800">
          ...
          <ul class="space-y-2 font-medium">
            ...
            <li>
              ...
              >
               <ListOrderedIcon></ListOrderedIcon>
                <span class="flex-1 ms-3 whitespace-nowrap">Your Order</span>
            ...
            <li>
              <Link
                to="/organizations/uploadproduct"
                class={`flex items-center ${
                  Pathname === "/organizations/uploadproduct"
            ...
            <li>
              ...
              >
                <EyeIcon></EyeIcon>
                <span class="flex-1 ms-3 whitespace-nowrap">View Product</span>
              </Link>
            </li>
          </ul>
        </div>
