          ...
          {Array.from({ length: 3 }).map(() => (
            <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
              ...
              <p className="mt-4 text-gray-700">
                "Sasto Bajar: Where affordability meets variety, and every
                purchase is a treasure hunt!" "Discover endless deals at Sasto
                Bajar - your one-stop shop for all things affordable and
                convenient." 
